#!/usr/bin/env bash
# App-Icon-Kandidaten erzeugen — AUF DEM MAC ausfuehren (mflux + Z-Image-Turbo).
# 8 Motive x 3 Seeds = 24 Bilder nach icons/candidates/.
# Verfahren/Modell: projektextern: local-llm/image-gen.md
#
# Voraussetzung auf dem Mac: mflux installiert (`mflux-generate` im PATH).
